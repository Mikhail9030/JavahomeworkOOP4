...
class AfishaManagerTest {
    ...
    void getLastLessZeroOutCount() {
        ...
        AfishaItem[] expected = new AfishaItem[]{item10, item9, item8, item7, item6, item5, item4, item3, item2};
    ...
    void getLastZeroOutCount() {
        ...
        AfishaItem[] expected = new AfishaItem[1];
        AfishaItem[] actual = manager.getLast();
    ...
    void add() {
        ...
        AfishaItem[] expected = new AfishaItem[]{item1, item2, item3, item4, item5, item6, item7, item8, item9, item10,};
